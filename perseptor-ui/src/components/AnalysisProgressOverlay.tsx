...
const STAGE_MAP: Record<string, StageConfig> = {
  ...
  siem:              { id: 'siem',          label: 'SIEM & Hunting Queries',  icon: <StorageIcon />,       color: '#7e57c2', group: 'siem' },
  siem_done:         { id: 'siem_done',     label: 'SIEM Detection Ready',   icon: <StorageIcon />,       color: '#7e57c2', group: 'siem' },
  hunting_done:      { id: 'hunting_done',  label: 'Hunting Queries Ready',  icon: <StorageIcon />,       color: '#f59e0b', group: 'siem' },
